...
// let allTitles = movies.map(movie => movie.title);
...
// let titleAndImdb = movies.map(movie =>  movie.title +" "+ movie.imdbRating
// )
...
// let dramaMovies = movies.filter(movie => movie.genre=="Drama"  && movie.imdbRating>8.5
// );
// console.log(dramaMovies);
// let actionMovies = movies.filter(movie => movie.actors[0]=""
// );
// console.log(actionMovies);

let dramaTim = movies.filter(movie => movie.genre == "Drama")
  .filter(movie => movie.actors[0] =="Tim Robbins")
